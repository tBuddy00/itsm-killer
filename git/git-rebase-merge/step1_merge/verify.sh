...
if [ ! -f main.txt ]; then
    echo "Error: File 'main.txt' does not exist."
    exit 1
fi

if ! grep -q "This is the main branch." main.txt; then
    echo "Error: The content 'This is the main branch.' was not found in 'main.txt'."
    exit 1
fi
